...
class UniformSampleFrames:
    ...
    def _get_train_clips(self, num_frames, clip_len):
        ...
        """
        # print("###########")
        # print(num_frames, clip_len)
        allinds = []
        # print("num_clips", self.num_clips)
        ...
        for clip_idx in range(self.num_clips):
            ...
            elif num_frames >= clip_len and num_frames < 2 * clip_len:
                # print("here")
    ...
    def __call__(self, results):
        ...
        # print(num_frames)
        # print(results.get('test_mode', False))
