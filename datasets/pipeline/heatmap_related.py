...
class GeneratePoseTarget:
    ...
    Args:
        sigma (float): The sigma of the generated the gaussian map. Default: 0.6.
        use_score (bool): Use the confidence score of keypoints as the maximum
            of the gaussian maps. Default: True.
        with_kp (bool): Genearate pseudo heatmaps for keypoints. Default: True.
    ...
    def __init__(self,
        ...
        assert self.with_kp + self.with_limb == 1, ('One of "with_kp" and "with_limb" should be set as True.')
    ...
    def generate_a_heatmap(self, arr, centers, max_values):
        ...
        for center, max_value in zip(centers, max_values):
            ...
            #If the keypoint not in the heatmap coordinates system
    ...
    def generate_a_limb_heatmap(self, arr, starts, ends, start_values, end_values):
        ...
        for start, end, start_value, end_value in zip(starts, ends, start_values, end_values):
            ...
            #distance between start and the end keypoint
            ...
            coeff = (d2_start + d2_ab - d2_end) / 2. / d2_ab
    ...
    def __call__(self, results):
        ...
        # self.with_kp = False
        # self.with_limb = True
        # heatmap_limb = self.gen_an_aug(results)
        # #print(heatmap.shape)
        # #print(heatmap_limb.shape)
        # heatmap = np.concatenate([heatmap, heatmap_limb],axis=0)
        # print(heatmap.shape)
        if self.double:
            heatmap = self.gen_an_aug(results)
